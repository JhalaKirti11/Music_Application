...
public class Admin {
    ...
    public void manageSongs() {
        ...
        while (running) {
            ...
            System.out.println("5. Create Your Album");
            System.out.println("6. View Your Albums");
            System.out.println("7. Add Song To Your Album");
            System.out.println("8. View Your Album Songs");
            System.out.println("9. Play Your Album Songs");
    ...
    private void deleteSong() {
        ...
        try {
            ...
            if (rowsAffected > 0) {
                ...
                System.out.println("\nNo song found with the specified title.");
            }
        } catch (SQLException e) {
            System.out.println("\nError deleting song.");
            //e.printStackTrace();
 ...
 String qur ="SELECT Album.AlbumName, allsongs.SongID, allsongs.Title, allsongs.Artist, allsongs.Path, Album.AlbumID FROM Album INNER JOIN AlbumSongs ON Album.AlbumID =AlbumSongs.AlbumID INNER JOIN allsongs ON AlbumSongs.SongID = allsongs.SongID";
        ...
        if(!albumFound){
            System.out.println("---Album Doesn't Found Or It Has No Song---");
        }
    ...
    public void playYourAlbumSong(){
        ArrayList<String> path = viewYourAlbumSongs();
